...
public class AbrigoService {
    ...
    public void listarAbrigo() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = clientHttpConfig.dispararRequisocaoGet(uri);
    ...
    private void mostrarAbrigos(Abrigo[] abrigos){
    ...
    public  void cadastrarAbrido() throws IOException, InterruptedException {
